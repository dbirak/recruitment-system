...
import boygreen from "../assets/boy/boygreen.png"
import girlgreen from "../assets/girl/girlgreen.png"
...
const Accepted = (props) => {
  ...
  return (
    <div className="mx-auto mt-2 min-w-[300px] w-[370px] px-3 overflow-hidden">
      <h1
        className={`text-center p-2 text-[27px] font-bold tracking-wide bg-green-600 text-white font-Kanit rounded-t-lg`}
      >
        {props.name}
      </h1>
                    ...
                    >
                      <div className="flex justify-between">
                        <img
                          ...
                          src={item.gender == "male" ? boygreen : girlgreen}
                          alt=""
                        />
